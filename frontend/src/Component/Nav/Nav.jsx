...
function Nav() {
    ...
    return (
        <nav
            className="h-screen bg-white flex items-center fixed flex-col border-solid border-0 border-r-2 border-r-gray-200 justify-between z-50 top-0 w-12">
            <div className="">
                <div>
                    <img src={`${__dirname}icon.png`} alt="anh icon" className="w-12 h-12 object-cover cursor-pointer"/>
                </div>
                <Link to={"/"}
                      className="text-2xl py-3 rounded hover:bg-gray-400 hover:text-black flex justify-center text-gray-400">
                    <BsHouse/>
                </Link>
                <Link to={"/"}
                      className="text-2xl py-3 rounded hover:bg-gray-400 hover:text-black flex justify-center text-gray-400">
            ...
            <div className="w-12">
                ...
                <div
                    className="text-2xl py-3 mb-6 cursor-pointer rounded hover:bg-gray-400 text-red-600 flex justify-center"
